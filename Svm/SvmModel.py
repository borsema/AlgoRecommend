...
class SvmModel:
    ...
    def train(self, **params):
        ...
        self.model = SVC(**params) if self.task_type == "classification" else SVR(**params)
    ...
    def _compute_feature_importance(self):
        if self.task_type == "classification" and self.model.kernel == "linear":
            importances = np.abs(self.model.coef_[0])
        elif self.task_type == "regression" and self.model.kernel == "linear":
